...
#===========================================================================
#
# Run Radx2Grid for multiDoppler analysis
#
#===========================================================================
...
def main():
    ...
    global options
    global scriptName
    scriptName = "runRadx2Grid.multidop.py"
    ...
    paramsDir = os.path.join(projDir, "multidop/params")
    paramsFile = os.path.join(paramsDir, "Radx2Grid.multidop.nexrad")
    if (radar_name.find("spol") > 0):
        paramsFile = os.path.join(paramsDir, "Radx2Grid.multidop.spol")
    ...
    cmd = "Radx2Grid -params " + paramsFile + " -debug -f " + dataFilePath
