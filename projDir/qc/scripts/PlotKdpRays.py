...
# parse the command line
    ...
    if (options.debug == True):
        print("Running PlotTitanTableType1:", file=sys.stderr)
        print("  inputFilePath: ", options.inputFilePath, file=sys.stderr)
        print("  maxGates: ", options.maxGates, file=sys.stderr)
...
def readFileList():
    ...
    if (options.debug == True):
        ...
        print("Input file path: ", options.inputFilePath, file=sys.stderr)
