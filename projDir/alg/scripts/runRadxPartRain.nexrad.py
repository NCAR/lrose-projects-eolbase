...
#===========================================================================
#
# Run RadxPartRain for nexrad data
#
#===========================================================================
...
def main():
    ...
    global options
    global scriptName
    scriptName = "runRadxPartRain.nexrad.py"
    ...
    paramsFile = os.path.join(paramsDir, "RadxPartRain.nexrad")
    ...
    cmd = "RadxPartRain -instance " + radar_name + " -params " + paramsFile + " -debug -f " + dataFilePath
