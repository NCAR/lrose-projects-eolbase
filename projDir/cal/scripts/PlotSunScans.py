...
# parse the command line
    ...
    parser.add_option('--ss_file',
                      dest='ssFilePath',
                      default='../data/pecan/spol_suncal_from_spdb.txt',
...
def doPlot(ssTimes, ssData, cpTimes, cpData, fluxTimes, fluxData):
    ...
    configureAxis(ax4, -9999.0, -9999.0, "ZDR analysis (dB)", 'upper right')

    fig1.suptitle("SPOL SUN SCAN ANALYSIS FOR RECEIVER GAIN AND ZDR BIAS")
    fig1.autofmt_xdate()
